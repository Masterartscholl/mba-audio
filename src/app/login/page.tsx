        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-app-card border border-app-border rounded-3xl p-8 shadow-xl">
            <form onSubmit={handleLogin} className="space-y-5">
              ...
              <div>
                <label className="block text-xs uppercase font-bold text-app-text-muted tracking-wider mb-1.5">{t('password')}</label>
                <input
                  required
                  type="password"
                  value={password}
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-app-primary text-app-primary-foreground font-bold py-3.5 rounded-xl hover:opacity-90 transition-opacity disabled:opacity-50 flex items-center justify-center gap-2"
              >
                {loading ? (
            ...
            <div className="relative my-6">
              ...
              <span className="relative flex justify-center text-xs uppercase font-bold text-app-text-muted tracking-wider">
                {t('or')}
              </span>
            </div>
