    ...
    return (
        <div className="fixed bottom-0 left-0 right-0 bg-[#0b1121]/90 backdrop-blur-xl border-t border-white/5 h-24 z-[100] px-8 flex items-center justify-between animate-in slide-in-from-bottom duration-500">
            ...
            <div className="flex items-center gap-4 w-1/4">
                ...
                <button className="ml-2 text-[#64748b] hover:text-red-500 transition-colors">
            ...
            <div className="flex flex-col items-center gap-2 flex-1 max-w-2xl px-12">
                <div className="flex items-center gap-8">
                    ...
                    <button className="text-white hover:text-[#ede066] transition-colors">
                        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24"><path d="M6 6h2v12H6zm3.5 6l8.5 6V6z" /></svg>
                    </button>
                    <button
                        onClick={togglePlay}
                        className="w-12 h-12 rounded-full bg-white flex items-center justify-center text-[#0b1121] transition-transform active:scale-90 hover:scale-105 shadow-xl shadow-white/10">
                        {isPlaying ? (
                ...
                <div className="w-full flex items-center gap-3">
                    ...
                    <div className="group relative flex-1 h-6 flex items-center">
                        <input
                            ...
                            style={{
                                background: `linear-gradient(to right, #ede066 ${(progress / (duration || 1)) * 100}%, #1e293b ${(progress / (duration || 1)) * 100}%)`
                            }}
                        />
                    </div>
                ...
                <div className="flex items-center gap-3 group">
                    ...
                    <div className="w-24 relative h-6 flex items-center">
                        <input
                            ...
                            className="absolute inset-0 w-full h-1.5 bg-[#1e293b] rounded-full appearance-none cursor-pointer accent-white z-10"
                            style={{
