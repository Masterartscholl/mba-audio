        ...
        <div className={`group flex items-center px-10 py-5 transition-all border-b border-white/5 hover:bg-white/[0.02] ${isActive ? 'bg-white/[0.03]' : ''}`}>
            ...
            <div className="w-48 flex items-center justify-end gap-2">
                <button
                    ...
                    className="px-4 py-2.5 bg-[#ede066]/10 border border-[#ede066]/30 rounded-xl text-[11px] font-black text-[#ede066] uppercase tracking-widest hover:bg-[#ede066] hover:text-[#0b1121] transition-all active:scale-95"
                >
                    {t('downloadWav')}
                </button>
                <button
                    onClick={() => handleDownload('mp3')}
                    className="px-4 py-2.5 bg-white/5 border border-white/10 rounded-xl text-[11px] font-black text-white uppercase tracking-widest hover:bg-white/10 transition-all active:scale-95"
                >
                    {t('downloadMp3')}
                </button>
            </div>
